...
pub fn d4_to_d3_lut16(c1:u8,c2:u8,c3:u8,c4:u8,lut:&Mft2) -> (f32,f32,f32) {
    ...
    let c1_delta= c1_delta as f32 / delta as f32;
    let c2_delta= c2_delta as f32 / delta as f32;
    let c3_delta= c3_delta as f32 / delta as f32;
    let c4_delta= c4_delta as f32 / delta as f32;

    let c1 = c11 as isize + ((c12 as isize - c11 as isize) as f32 * c1_delta) as isize;
    let c2 = c21 as isize + ((c22 as isize - c21 as isize) as f32 * c2_delta) as isize;
    let c3 = c31 as isize + ((c32 as isize - c31 as isize) as f32 * c3_delta) as isize;
    let c4 = c41 as isize + ((c42 as isize - c41 as isize) as f32 * c4_delta) as isize;

    let c1_grid = ((c1 as f32 / 65536.0) * grid_points as f32).floor() as usize;
    let c2_grid = ((c2 as f32 / 65536.0) * grid_points as f32).floor() as usize;
    let c3_grid = ((c3 as f32 / 65536.0) * grid_points as f32).floor() as usize;
    let c4_grid = ((c4 as f32 / 65536.0) * grid_points as f32).floor() as usize;

    let c1_grid_delta= ((c1 as f32 / 65536.0) * grid_points as f32) - c1_grid as f32;
    let c2_grid_delta= ((c2 as f32 / 65536.0) * grid_points as f32) - c2_grid as f32;
    let c3_grid_delta= ((c3 as f32 / 65536.0) * grid_points as f32) - c3_grid as f32;
    let c4_grid_delta= ((c4 as f32 / 65536.0) * grid_points as f32) - c4_grid as f32;
    ...
    let d1 = lut.clut_values[grid]   as f32 * (1.0  -grid_delta) + lut.clut_values[grid2]   as f32 * grid_delta;
    let d2 = lut.clut_values[grid+1] as f32 * (1.0  -grid_delta) + lut.clut_values[grid2+1] as f32 * grid_delta;
    let d3 = lut.clut_values[grid+2] as f32 * (1.0  -grid_delta) + lut.clut_values[grid2+2] as f32 * grid_delta;
    ...
    let od1_delta= d1 / dev - od1 as f32;
    let od2_delta= d2 / dev - od2 as f32;
    let od3_delta= d3 / dev - od3 as f32;
    ...
    let d1 = d11 as f32 * (1.0 - od1_delta) + d12 as f32 * od1_delta;
    let d2 = d21 as f32 * (1.0 - od2_delta) + d22 as f32 * od2_delta;
    let d3 = d31 as f32 * (1.0 - od3_delta) + d32 as f32 * od3_delta;
